...
public class YOSHIController : MonoBehaviour {
    ...
    void MoveEnemy()
    {
        ...
        {
            targetLocation = WaluigiPosition;
        }
        else
        {
    ...
    bool GoGhost()
    {
        ...
        if (Mathf.CeilToInt(ghostTimer * Mathf.Sqrt(randomNum2)) % randomNum1 == 0)
        {
            ...
            {
                ghostDestination.x = WaluigiPosition.x;
                ghostDestination.y = WaluigiPosition.y;
